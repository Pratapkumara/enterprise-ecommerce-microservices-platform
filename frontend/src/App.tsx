    ...
    const loadProducts = async () => {
      try {
        ...
        const liveProducts = payload
          ...
          .map((product, index): Product => {
            const productCategory =
              product.category?.trim() || "Electronics";
            ...
            return {
              ...
              tone: visual.tone,
              badge:
                index === 0 ? "Live catalogue" : undefined,
            };
          });
        ...
        if ((error as Error).name !== "AbortError") {
          console.warn(
            "Product API unavailable; using demo catalogue.",
          );
    ...
    <main>
      ...
      <header className="site-header">
        ...
        <div className="header-actions">
          ...
          <button
            className="icon-action desktop-action"
            onClick={() => {
              setCategory("All");
              scrollToProducts();
            }}
      ...
      <section className="hero">
        <div className="hero-copy">
          ...
          <p className="hero-description">
            High-performance business laptop built for speed,
            focus and all-day productivity.
          </p>
        ...
        <div
          ...
          aria-label="Enterprise Laptop Pro"
        >
          ...
          <img
            src="/hero-laptop.png"
            alt="Graphite high-performance business laptop"
          />
      ...
      >
        <div className="section-heading">
          <div>
            ...
            <p
              className={`catalogue-status ${catalogueSource}`}
            >
              <span />
      ...
      <section className="newsletter">
        <div>
          ...
          <p>
            Weekly offers and useful product updates. No
            noise.
          </p>
        </div>
      ...
      <footer>
        ...
        <small>
          © 2026 Pratap Store. Built with a
          ...
          >
            ...
            {cartProducts.length === 0 ? (
              <div className="drawer-empty">
                ...
                <p>
                  Great products are only a click away.
                </p>
              ...
              <>
                <div className="cart-items">
                  {cartProducts.map(
                    (product, index) => (
                      ...
                      >
                        <span
                          className={`mini-product ${product.tone}`}
                        >
                          {product.icon}
                        </span>
                ...
                <p className="shipping-note">
                  Free delivery included. Taxes calculated
                  at checkout.
                </p>
      ...
      {accountOpen && (
        ...
        >
          ...
          >
            ...
            <p>
              Access your orders, wishlist and personalised
              deals.
            </p>
            ...
            <p className="modal-foot">
              New here? <button>Create an account</button>
            </p>
          </section>
        </div>
      )}
